...
def pretrain_embeddings_LSTM_CONV_OVERSAMPLING(embeddings_path, train_xs, train_ys, test_xs, test_ys=None, epochs=25,
    ...
    new_train_xs, new_train_ys = oversampling(train_xs, train_ys)

    # Build vocabulary and corpus indexes
    vocabulary_train, corpus_train_index = fit_transform_vocabulary_pretrain_embeddings(new_train_xs, word_emb_indexes)
    ...
    np_labels_train = np.array(new_train_ys)
