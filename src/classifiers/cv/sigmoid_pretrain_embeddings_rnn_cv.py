...
def sigmoid_pretrain_embeddings_rnn_cv(model_name, embeddings_path, train_xs, train_ys, test_xs, test_ys=None,
                                       verbose=1):
    own_set_seed()
    ...
    for train_xs, train_ys, val_xs, val_ys in data_k_fold:
        labels_fold_i, history_i = sigmoid_pretrain_embeddings_rnn(embeddings_path, train_xs, train_ys, val_xs, val_ys,
                                                                   verbose)
