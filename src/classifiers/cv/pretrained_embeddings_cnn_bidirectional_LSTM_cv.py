from src.classifiers.single.pretrained_embeddings_cnn_bidirectional_LSTM import pretrained_embeddings_cnn_bidirectional_LSTM

from src.util.utilities import *


def pretrained_embeddings_cnn_bidirectional_LSTM_cv(model_name, embeddings_path, train_xs, train_ys, test_xs, test_ys=None, verbose=1):
    own_set_seed()
    ...
    for train_xs, train_ys, val_xs, val_ys in data_k_fold:
        labels_fold_i, history_i = pretrained_embeddings_cnn_bidirectional_LSTM(embeddings_path, train_xs, train_ys, val_xs, val_ys, verbose)
