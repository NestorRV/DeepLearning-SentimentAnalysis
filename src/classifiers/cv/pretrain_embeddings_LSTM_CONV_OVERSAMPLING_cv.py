...
def pretrain_embeddings_LSTM_CONV_OVERSAMPLING_cv(embeddings_path, train_xs, train_ys, test_xs, test_ys=None, epochs=25,
                                                  verbose=1):
    own_set_seed()
    ...
    for train_xs, train_ys, val_xs, val_ys in data_k_fold:
        labels_fold_i = pretrain_embeddings_LSTM_CONV_OVERSAMPLING(embeddings_path, train_xs, train_ys, val_xs, val_ys,
                                                                   epochs,
                                                                   verbose)
