...
def pretrain_embeddings_rnn_cv(embeddings_path, train_xs, train_ys, test_xs, classes_to_num_dic, test_ys=None,
    ...
    for train_xs, train_ys, val_xs, val_ys in data_k_fold:
        labels_fold_i = pretrain_embeddings_rnn(embeddings_path, train_xs, train_ys, val_xs, val_ys, epochs, verbose,
                                                num_classes)
