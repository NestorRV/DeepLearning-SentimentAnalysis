...
def tfidf_rnn_cv(embeddings_path, train_xs, train_ys, test_xs, classes_to_num_dic, test_ys=None, epochs=25, verbose=1, num_classes=4):
    own_set_seed()

    model_name = "tfidf_rnn"
    ...
    for train_xs, train_ys, test_xs, test_ys in data_k_fold:
        labels_fold_i = tfidf_rnn(embeddings_path, train_xs, train_ys, test_xs, test_ys, epochs, verbose, num_classes)
